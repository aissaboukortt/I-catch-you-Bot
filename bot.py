...
async def start(update, context):
    ...
    if flask_process is None:
        ...
        await update.message.reply_text("✅ Server (Flask) Started successfully on Render!")
    else:
...
async def stop(update, context):
    ...
    if flask_process:
        ...
        await update.message.reply_text("⚠️ Server is not running")

# =========================
# (باقي الدوال: status, images, infos كما هي)
# =========================
